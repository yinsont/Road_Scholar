function scoreCalculator (overallScore, distance, duration, distancePercentError, durationPercentError) {

    if (distance > 2000){
        if (distancePercentError < 10) {
